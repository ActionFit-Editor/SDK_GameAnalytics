...
{
  "dependencies": {
    "com.actionfit.sdk.gameanalytics": "https://github.com/ActionFit-Editor/SDK_GameAnalytics.git#1.0.6"
  }
}
```

`ActionFit-Editor/SDK_GameAnalytics` repository와 위의 정확한 version tag가 실제로 게시된 뒤 사용할 수 있습니다.
